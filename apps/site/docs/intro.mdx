...
<div className="hero-banner">
  <h2>🚀 Supercharged State Management for Modern Applications</h2>
  <p>Fast, type-safe, and elegantly simple reactive state management with deep MobX integration and optional Y.js two-way binding.</p>
</div>
...
<style jsx>{`
  .hero-banner {
    background: linear-gradient(90deg, #0d111705 0%, #161b2207 50%);
    border-radius: 8px;
    padding: 24px;
    margin: 30px 0;
